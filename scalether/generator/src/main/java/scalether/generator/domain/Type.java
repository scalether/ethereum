...
public enum Type {
    SCALA("", "", "", "", "", "", "cats.Functor", "org.ethereum.cats.MonadThrowable", "cats.implicits._"),
    MONO("Mono", "reactor.core.publisher.Mono", "org.ethereum.cats.implicits._", "MonoTransactionSender", "MonoTransactionPoller", "MonoPreparedTransaction"),
    ID("Id", "cats.Id", "org.ethereum.cats.implicits._", "IdTransactionSender", "IdTransactionPoller", "IdPreparedTransaction");
